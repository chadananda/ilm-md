...
"use strict";var jsyaml=require("yaml-front-matter"),css=require("./main.css"),markdownItComments=require("markdown-it-inline-comments"),markdownItAttrs=require("markdown-it-attrs"),markdownItFootnote=require("markdown-it-footnote"),markdownItTableOfContents=require("markdown-it-toc-ilm"),markdownItAnchor=require("markdown-it-anchor"),markdownItParnum=require("markdown-it-parnum"),md=require("markdown-it")({html:!0,linkify:!0,typographer:!0,quotes:"“”‘’"}).use(markdownItComments).use(markdownItAnchor).use(markdownItFootnote).use(markdownItParnum).use(markdownItTableOfContents,{includeLevel:[2,3,4,5],containerClass:"toc",format:function(t){return t.replace(/\{.*?\}[\s]*$/,"")}}).use(markdownItAttrs);module.exports=function(t){var r={raw_md:t,attrs:{},raw_content:"",ilm_obj:{},html_body:"",html_head:"",html:""};r.attrs=jsyaml.parse(t.trim()),r.raw_content=r.attrs.__content.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,""),delete r.attrs.__content;var e=md.render(r.raw_content);return r.html_body=e,r.html=e,r};
